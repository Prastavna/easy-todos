        ...
        <div class="grid grid-cols-[repeat(auto-fit,minmax(320px,1fr))] gap-1.5 px-2 pb-2">
          ...
          >
            ...
            <div class="absolute right-2 top-2 flex items-center gap-1">
              ...
              >
                <Icon :icon="todo.completed ? 'solar:check-circle-bold' : 'solar:check-circle-linear'" class="size-3.5" />
              </Button>
              <Button class="size-7 rounded-full" size="icon" variant="outline" aria-label="Edit todo" title="Edit todo" @click="emit('edit', todo)">
                <Icon class="size-3.5" icon="solar:pen-linear" />
              </Button>
              <Button class="size-7 rounded-full" size="icon" variant="destructive" aria-label="Delete todo" title="Delete todo" @click="emit('remove', todo.id)">
